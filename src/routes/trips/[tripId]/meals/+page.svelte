...
<div class="page">
	<div class="page-header">
		<h1>Meals</h1>
		<p class="subtitle">Meal plan and sign-ups for this trip</p>
	</div>
										...
										<div class="slot-display">
											...
											{#if data.isHost}
												<div class="slot-actions">
													...
													<form method="POST" action="?/deleteMealSlot" use:enhance={handleResult} class="inline-form">
														<input type="hidden" name="slotId" value={slot.id} />
